...
# ===========================================================================
HOST = "sango"   # shown as  sango@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "BICT (Hons) Undergrad, Univ. of Vavuniya"),
    ("kv", "Track", "Backend Dev — Java, Spring Boot, MySQL"),
    ("kv", "Leads", "Media & Marketing Dir @ ZeroPlastic Club"),
    ("kv", "Also", "Lead @ Unipods Lens Photography Club"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Backend", "Java, Spring Boot, MySQL, REST APIs"),
    ("kv", "Languages", "Java, C#, C++, Python"),
    ("kv", "Tools", "Git, GitHub, Figma, Canva"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "CGPA 3.8 / 4.0"),
    ("bul", "IEEE VanniXtreme 2.0 Hackathon participant"),
    ("bul", "U.S. Embassy Sri Lanka USBus event"),
]
